...
export function AdminProvider({ children }) {
  ...
  const loadAdminData = useCallback(async () => {
    ...
    setIsLoading(true);
    try {
      const [usersRes, rolesRes, coursesRes, catsRes, blogsRes, enrollsRes] =
        await Promise.all([
          api
            .get("/users?populate=role", { token })
            .catch(() => ({ data: [] })),
          api
      ...
      // is identical to what the Student, Instructor, and Content Manager dashboards see.
  ...
  const filteredUsers = users.filter((u) => {
    ...
    const matchRole =
      userRoleFilter === "all" ||
      u.role?.name?.toLowerCase() === userRoleFilter.toLowerCase();
  ...
  return (
    <AdminContext.Provider value={value}>
      ...
      <ConfirmDeleteModal
        ...
        description="Are you sure you want to delete this course? This will remove all associated modules, lessons, and quizzes."
      ...
      <ConfirmDeleteModal
        ...
        description="Are you sure you want to remove this video lesson from the course curriculum?"
      ...
      <ConfirmDeleteModal
        ...
        description="Are you sure you want to delete this quiz and its assessment questions?"
      ...
      <ConfirmDeleteModal
        ...
        description="Are you sure you want to delete this article? It will be permanently removed from the blog."
