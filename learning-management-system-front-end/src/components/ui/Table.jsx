...
export function Table({ headers, children, className = "", ...props }) {
  return (
    <div
      className={`w-full overflow-x-auto rounded-2xl border border-border bg-card shadow-1 ${className}`}
    >
      <table
...
export function TableBody({ children, className = "", ...props }) {
  return (
    <tbody
      className={`divide-y divide-border text-foreground ${className}`}
      {...props}
    >
      {children}
    </tbody>
...
export function TableHead({ children, className = "", ...props }) {
  return (
    <th
      className={`px-4 py-3.5 sm:px-6 font-extrabold text-[11px] text-muted uppercase tracking-wider ${className}`}
      {...props}
    >
      {children}
    </th>
...
export function TableRow({ children, className = "", ...props }) {
  return (
    <tr
      className={`hover:bg-[#E7F8EE]/20 dark:hover:bg-surface-hover transition-colors ${className}`}
      {...props}
    >
      {children}
    </tr>
