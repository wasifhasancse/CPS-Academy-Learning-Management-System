          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-border">
            <div>
              <div className="flex items-center gap-2">
                ...
                <Badge variant="primary" className="text-[10px]">Super Admin</Badge>
              </div>
              <p className="text-sm text-muted">
                Full platform governance, user role mutation, global course/curriculum curation, and blog publishing.
              </p>
            </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                      <Card className="bg-surface border-border">
                        <CardContent className="p-4">
                          ...
                          <p className="text-[11px] text-muted mt-1">All accounts</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="bg-surface border-border">
                        <CardContent className="p-4">
                          ...
                          <div className="text-2xl font-extrabold text-primary dark:text-highlight mt-1">
                            {adminCount}
                          </div>
                          <p className="text-[11px] text-muted mt-1">Full access</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="bg-surface border-border">
                        <CardContent className="p-4">
                          ...
                          <p className="text-[11px] text-muted mt-1">Curators</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="bg-surface border-border">
                        <CardContent className="p-4">
                          ...
                          <p className="text-[11px] text-muted mt-1">Educators</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="bg-surface border-border">
                        <CardContent className="p-4">
                          ...
                          <p className="text-[11px] text-muted mt-1">Learners</p>
                        </CardContent>
                      </Card>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                      <Card className="bg-surface border-border">
                        <CardContent className="p-4">
                          ...
                          <p className="text-[11px] text-muted mt-1">Platform tracks</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="bg-surface border-border">
                        <CardContent className="p-4">
                          ...
                          <p className="text-[11px] text-muted mt-1">Assessments</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="bg-surface border-border">
                        <CardContent className="p-4">
                          ...
                          <p className="text-[11px] text-muted mt-1">Student seats</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="bg-surface border-border">
                        <CardContent className="p-4">
                          ...
                          <p className="text-[11px] text-muted mt-1">{publishedBlogsCount} live • {draftBlogsCount} drafts</p>
                        </CardContent>
                      </Card>
                    </div>
                  </div>
